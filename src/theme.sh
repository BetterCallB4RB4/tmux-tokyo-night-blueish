...
theme_variation=$(get_tmux_option "@theme_variation" "storm")
...
tmux set-option -g pane-border-style fg=#b4f9f8
tmux set-option -g pane-active-border-style fg=#b4f9f8
